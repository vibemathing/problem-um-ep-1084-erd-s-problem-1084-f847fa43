...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1084-erd-s-problem-1084-f847fa43-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1084"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1084-erd-s-problem-1084-f847fa43-v1",
      "problem_contract_sha256": "262947fa35014a576aa0846b4d532a2184c9038acd57775680a1beefdbf18e52",
      "problem_id": "problem:um-ep-1084-erd-s-problem-1084-f847fa43",
      "route_id": "route:um-ep-1084-erd-s-problem-1084-f847fa43-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1084-erd-s-problem-1084-f847fa43-source-fidelity-01",
      "graph_id": "graph:um-ep-1084-erd-s-problem-1084-f847fa43-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1084-erd-s-problem-1084-f847fa43-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1084-erd-s-problem-1084-f847fa43-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f_d(n)$ be minimal such that in any collection of $n$ points in $\\mathbb{R}^d$, all of distance at least $1$ apart, there are at most $f_d(n)$ many pairs of points which are distance $1$ apart. Estimate $f_d(n)$."
          },
          "statement_sha256": "e9ffd55415e36e230142d32bf18ae3b95eb41a01529a27398a894f69a819ba82"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1084-erd-s-problem-1084-f847fa43-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1084-erd-s-problem-1084-f847fa43-root",
      "route_id": "route:um-ep-1084-erd-s-problem-1084-f847fa43-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1084-fb9d017d0237",
        "url": "https://www.unsolvedmath.com/problems/EP-1084"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
